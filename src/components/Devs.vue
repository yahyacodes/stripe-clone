<template>
  <section class="relative devs xl:py-80 sm:py-96 xl:-mt-80 sm:-mt-96">
        ...
        <div class="container 2xl:ml-0 sm:ml-5">
          ...
          <div class="flex flex-row">
            <div class="xl:columns-2 sm:columns-1 gap-20 mt-10 2xl:ml-64">
              ...
              <h1
                class="text-white font-bold text-lg xl:mt-2 sm:mt-4 border-cyan-400 border-l-2"
              >
                Tools for every stack
              </h1>
              <p class="text-gray-400 xl:w-64 xl:mt-2 sm:w-80 sm:mt-4">
              ...
              <fa icon="box" class="text-cyan-400 scale-150 mt-5" />
              <fa icon="box" class="text-cyan-400 scale-150 ml-2" />
              <h1
                class="text-white font-bold text-lg border-cyan-400 border-l-2 mt-2"
              >
                Prebuilt integrations
              </h1>
              <p class="text-gray-400 xl:w-64 xl:mt-2 sm:w-96 sm:mt-4">
